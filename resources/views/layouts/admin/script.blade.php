...
<script src="{{ asset('admin/assets/js/vendor/forms/validation/validate.min.js') }}"></script>
...
<script src="{{ asset('admin/assets/demo/pages/form_validation_library.js') }}"></script>
