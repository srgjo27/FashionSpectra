                ...
                <div class="row justify-content-between">
                    <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-1 mb-50">
                            <div class="tp-footer-widget-content">
                                ...
                                <p class="tp-footer-desc">FashionSpectra merupakan toko online yang menyediakan berbagai
                                    macam produk fashion seperti pakaian, sepatu, aksesori, dan produk-produk
                                    kecantikan.</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-4 mb-50">
                            <h4 class="tp-footer-widget-title">Hubungi kami</h4>
                            <div class="tp-footer-widget-content">
                                <div class="tp-footer-talk mb-20">
                                    <span>Jika ada pertanyaan? Hubungi</span>
                                    <h4><a href="tel:670-413-90-762">+62 8xx xxxx xxxx</a></h4>
                                </div>
                                <div class="tp-footer-contact">
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                        ...
                                        <div class="tp-footer-contact-content">
                                            <p><a href="mailto:shofy@support.com">fashionspectra@gmail .com</a></p>
                                        </div>
                                    </div>
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                        <div class="tp-footer-contact-icon">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="tp-footer-copyright">
                                <p>&copy; 2023 FashionSpectra - by <a href="">srgjo27</a>.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="tp-footer-payment text-md-end">
                                <p>
                                    <img src="{{ asset('web/assets/img/footer/footer-pay.png') }}" alt="">
                                </p>
                            </div>
                        </div>
                    </div>
