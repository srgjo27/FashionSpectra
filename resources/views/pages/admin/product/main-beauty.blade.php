    ...
    <div class="content">
        ...
        <div class="card">
            ...
            {{-- <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#beauty-tab1" class="nav-link active" data-bs-toggle="tab">Pakaian
                        Pria</a></li>
                <li class="nav-item"><a href="#beauty-tab2" class="nav-link" data-bs-toggle="tab">Celana Pria</a></li>
                <li class="nav-item"><a href="#beauty-tab3" class="nav-link" data-bs-toggle="tab">Pakaian Wanita</a>
                </li>
                <li class="nav-item"><a href="#beauty-tab4" class="nav-link" data-bs-toggle="tab">Celana/Rok
                        Wanita</a></li>
                <li class="nav-item"><a href="#beauty-tab5" class="nav-link" data-bs-toggle="tab">Pakaian
                        Anak-anak</a></li>
                <li class="nav-item"><a href="#beauty-tab6" class="nav-link" data-bs-toggle="tab">Pakaian Bayi</a>
                </li>
            </ul> --}}

            <div class="tab-content">
                <div class="tab-pane fade show active" id="beauty-tab1">
