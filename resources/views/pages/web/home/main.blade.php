            ...
            <div class="row align-items-end">
                <div class="col-xl-5 col-lg-6 col-md-5">
                    <div class="tp-section-title-wrapper mb-40">
                        <h3 class="tp-section-title">Produk
                        ...
                        <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="new-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="new-tab-pane" aria-selected="true">Terbaru
                                ...
                                <div class="row">
                                    @foreach ($products as $item)
                                        @php
                                            ...
                                            $isNewProduct = $item->created_at > $oneWeekAgo;
                                        @endphp
                                        @if ($isNewProduct)
                                                ...
                                                <div class="tp-product-item p-relative transition-3 mb-25">
                                                    <div class="tp-product-thumb p-relative fix m-img">
                                                        <a href="{{ route('user.product.show', $item->id) }}">
                                                            <img src="{{ asset('storage/public/product/' . $item->image) }}"
                                                                alt="" height="270">
                                                        </a>
                                                        <!-- product badge -->
                                                        <div class="tp-product-badge">
                                                            @if ($item->created_at->diffInDays() < 7)
                                                                <span class="product-sale">Terbaru</span>
                                                            @endif
                                                            @if ($item->stock->quantity >= 20)
                                                                <span class="product-trending">Tersedia</span>
                                                            @else
                                                                <span class="product-hot">Habis</span>
                                                            @endif
                                                        </div>
                                                        <!-- product action -->
                                                        <div class="tp-product-action">
                                                            <div class="tp-product-action-item d-flex flex-column">
                                                                <button type="button"
                                                                    ...
                                                                    <span class="tp-product-tooltip">Tambahkan ke
                                                                        keranjang</span>
                                                                </button>
                                                                <button type="button"
                                                                    ...
                                                                    <span class="tp-product-tooltip">Lihat</span>
                                                                </button>
                                                                <button type="button"
                                                                    ...
                                                                    <span class="tp-product-tooltip">Suka</span>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="tp-product-item transition-3 mb-25">
                                            <div class="tp-product-thumb p-relative fix m-img">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('web/assets/img/product/product-5-2.jpg') }}"
                                            ...
                                            <div class="tp-product-content">
                                                ...
                                                <div class="tp-product-price-wrapper">
                                                    <span class="tp-product-price">$100.00</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-sm-6">
                                        <div class="tp-product-item transition-3 mb-25">
                                            <div class="tp-product-thumb p-relative fix m-img">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('web/assets/img/product/product-2.jpg') }}"
                                                        alt="product-electronic">
                                                </a>
                                                <!-- product badge -->
                                                <div class="tp-product-badge">
                                            ...
                                            <div class="tp-product-content">
                                                ...
                                                <div class="tp-product-price-wrapper">
                                                    <span class="tp-product-price">$80.00</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <nav>
                            <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">
                                    <img src="{{ asset('storage/public/product/' . $item->image) }}" alt="">
                                </button>
                            </div>
                        </nav>
