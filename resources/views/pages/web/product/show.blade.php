                            ...
                            <nav>
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">
                                        <img src="{{ asset('storage/public/product/' . $product->image) }}"
                                            alt="">
                                    </button>
                                </div>
                            </nav>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                            ...
                            <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                                <div class="tp-product-details-stock mb-10">
                                    @if ($product->stock->quantity >= 20)
                                        <span class="in-stock text-bg-primary">Tersedia</span>
                                    @else
                                        <span class="out-of-stock text-bg-danger">Stok Habis</span>
                                    @endif
                                </div>
                            ...
                            <div class="tp-product-details-action-wrapper">
                                <h3 class="tp-product-details-action-title">Jumlah</h3>
                                <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                    ...
                                    <div class="tp-product-details-add-to-cart mb-15 w-100">
                                        <button class="tp-product-details-add-to-cart-btn w-100">Tambah ke
                                            Keranjang</button>
                                    </div>
                                </div>
                                <button class="tp-product-details-buy-now-btn w-100">Beli Sekarang</button>
                            </div>
                            ...
                            <div class="tp-product-details-msg mb-15">
                                <ul>
                                    <li>30 hari pengembalian mudah</li>
                                    <li>Pesan diusahakan dikirim di hari yang sama</li>
                                </ul>
                            </div>
                            <div
                                class="tp-product-details-payment d-flex align-items-center flex-wrap justify-content-between">
                                <p>Dijamin aman & pembayaran yang aman</p>
                                <img src="{{ asset('web/assets/img/product/icons/payment-option.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                            ...
                            <nav>
                                <div class="nav nav-tabs justify-content-center p-relative tp-product-tab"
                                    ...
                                    <button class="nav-link active" id="nav-addInfo-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="nav-addInfo" aria-selected="false">Deskripsi</button>
                                    <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-review" type="button" role="tab"
                                        aria-controls="nav-review" aria-selected="false">Ulasan (2)</button>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="tp-product-details-review-statics">
                                                    ...
                                                    <div class="tp-product-details-review-number d-inline-block mb-50">
                                                        <h3 class="tp-product-details-review-number-title">Ulasan
                                                            Pembeli</h3>
                                                        <div
                                                    ...
                                                    <div class="tp-product-details-review-list pr-110">
                                                        <h3 class="tp-product-details-review-title">Penilaian & Ulasan
                                                        </h3>
                                                        <div
                                                            class="tp-product-details-review-avater d-flex align-items-start">
                                                            <div class="tp-product-details-review-avater-thumb">
                                                                <a href="#">
                                                                    <img src="{{ asset('web/assets/img/users/user-3.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="tp-product-details-review-avater-content">
                                                                ...
                                                                <div class="tp-product-details-review-avater-comment">
                                                                    <p>Lorem ipsum dolor sit amet consectetur
                                                                        adipisicing elit. Optio nihil suscipit non at?
                                                                        Tempore aliquid repudiandae ad illo quos
                                                                        aspernatur voluptatibus, magnam expedita nobis
                                                                        sapiente vitae ratione aut soluta minus.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <form action="#">
                                                        ...
                                                        <div class="tp-product-details-review-input-wrapper">
                                                            <div class="tp-product-details-review-input-box">
                                                                <div class="tp-product-details-review-input">
                                                                    <textarea id="msg" name="msg" placeholder="Tulis ulasan anda disini..."></textarea>
                                                                </div>
                                                                <div class="tp-product-details-review-input-title">
                                                                    <label for="msg">Ulasan</label>
                                                                </div>
                                                            </div>
                                                            <div class="tp-product-details-review-input-box">
                                                                <div class="tp-product-details-review-input">
                                                        ...
                                                        <div class="tp-product-details-review-suggetions mb-20">
                                                            <div class="tp-product-details-review-remeber">
                                                                ...
                                                                <label for="remeber">Simpan nama, email, dan situs web
                                                                    di browser ini untuk komentar saya
                                                                    berikutnya.</label>
                                                            </div>
                                                        </div>
